 ...
 */
class getVatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VatRepository' shared autowired service.
     *
     * @return \App\Repository\VatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VatRepository.php';

        return $container->privates['App\\Repository\\VatRepository'] = new \App\Repository\VatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
